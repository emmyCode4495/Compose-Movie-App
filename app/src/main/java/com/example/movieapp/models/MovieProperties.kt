...
fun getMovies(): List<MovieProperties> {
    return listOf(
        MovieProperties(id = "tt0499549",
            title = "Avatar",
            year = "2009",
